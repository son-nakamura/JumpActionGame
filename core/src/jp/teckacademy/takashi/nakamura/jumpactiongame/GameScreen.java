...
public class GameScreen extends ScreenAdapter {
    ...
    Sound mSound = Gdx.audio.newSound(Gdx.files.internal("collision.mp3"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.takashi.nakamura.jumpactionGame");
    ...
    public void render(float delta) {
        ...
        // カメラの中心を超えたらカメラを上に移動させる　つまりキャラが画面の上半分には行かない
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.6f) {
                ...
                star.setPosition(step.getX() + mRandom.nextFloat(), step.getY() + Star.STAR_HEIGHT + mRandom.nextFloat());
                mStars.add(star);
            }
            ...
            if (mRandom.nextFloat() > 0.7f) {
                ...
                enemy.setPosition(x, step.getY() + Enemy.ENEMY_HEIGHT * 1.5f + mRandom.nextFloat());
                mEnemies.add(enemy);
            }
    ...
    private void checkCollision() {
        ...
        for (int i = 0; i < mEnemies.size(); i++) {
            ...
            if (mPlayer.getBoundingRectangle().overlaps(enemy.getBoundingRectangle())) {
                // サウンドを鳴らす
                long play = mSound.play();
                Gdx.app.log("JumpActionGame", "SOUND_RETURN:" + String.valueOf(play));
